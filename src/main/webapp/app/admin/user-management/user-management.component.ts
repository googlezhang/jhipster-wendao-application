      ...
      this.userManagementService
        ...
        .then(res => {
          this.alertService.showInfo(
            this.t$(res.headers['x-wendaojhipstersampleapplicationapp-alert'].toString(), {
              param: decodeURIComponent(res.headers['x-wendaojhipstersampleapplicationapp-params'].replace(/\+/g, ' ')),
            }),
            { variant: 'danger' },
          );
          this.removeId = null;
